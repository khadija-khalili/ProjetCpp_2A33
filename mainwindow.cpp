...
void MainWindow::on_pb_ajouter_clicked()
{
    ...
    Personnel P (id_personnel,nom,prenom,email,num_tel,sexe);
    bool test=P.ajouter();
    QMessageBox msgBox;
    if(test){
...
{
 Personnel P1;P1.setid_personnel(ui->le_id->text().toInt());
...
void MainWindow::on_Search_Nom_textChanged(const QString &arg1)
{
    ui->table_personnel->setModel(P.rechercherNom(arg1));
}

void MainWindow::on_Search_Prenom_textChanged(const QString &arg1)
{
