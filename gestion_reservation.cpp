...
gestion_reservation::gestion_reservation(int num,int nb_per,QString heure_d,QString heure_f,int num_tel,QString type)
{
...
bool gestion_reservation::ajouter()
{
    QSqlQuery query;
...
bool gestion_reservation::modifier()
{
    QSqlQuery query ;
    QSqlQuery query1;
    int b=0;
...
QSqlQueryModel * gestion_reservation::afficher()
{
...
bool gestion_reservation::supprimer(int idA)
{
...
QString gestion_reservation:: apercu_pdf()
 {
...
QSqlQueryModel * gestion_reservation::rechercherID(QString id)
{
    QSqlQueryModel *model= new QSqlQueryModel();
    QSqlQuery q;
...
QSqlQueryModel * gestion_reservation::AfficherTrieID()
{
    QSqlQueryModel * model = new QSqlQueryModel();
